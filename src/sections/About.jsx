                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext"> I specialize in JavaScript with a
                                focus on React and Next.js ecosystems.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="xl:col-span-2 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext"> I love solving problems and
                                building things through code. </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="xl:col-span-1 xl:row-span-2">
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            <p className="grid-subtext text-center lg:text-2xl md:text-lg font-medium text-gray_gradient text-white">Contact Me</p>
                            <div className="copy-container" onClick={handleCopy} >
                                <img src={hasCopied ? "assets/tick.svg" : "assets/copy.svg"} alt="copy" />
                                <p className="lg:text-2xl md:text-lg font-medium text-gray_gradient text-white">mdidris10215@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
